...
ActiveRecord::Schema[7.0].define(version: 2023_05_04_185721) do
  ...
  create_table "join_stroll_dogs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "stroll_id", null: false
    t.integer "dog_id", null: false
    t.index ["dog_id"], name: "index_join_stroll_dogs_on_dog_id"
    t.index ["stroll_id"], name: "index_join_stroll_dogs_on_stroll_id"
  end
  ...
  add_foreign_key "join_stroll_dogs", "dogs"
  add_foreign_key "join_stroll_dogs", "strolls"
